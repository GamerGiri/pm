...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5736579519').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://devilbot:Rajbot@cluster0.ldrbggy.mongodb.net/?retryWrites=true&w=majority")
...
VERIFY2_URL = environ.get('VERIFY2_URL', "links4money.com")
VERIFY2_API = environ.get('VERIFY2_API', "840e693cc062c57cb5383685491059ef2f65e3b9")
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'moneycase.link')
SHORTLINK_API = environ.get('SHORTLINK_API', '600ea6946edfb286f42f5797da7ed68e7c855f50')
SHORTLINK_URL = environ.get('SHORTLINK_URL', 'links4money.com')
SHORTLINK_API = environ.get('SHORTLINK_API', '840e693cc062c57cb5383685491059ef2f65e3b9')
IS_SHORTLINK = is_enabled((environ.get('IS_SHORTLINK', 'False')), False)
DELETE_CHANNELS = [int(dch) if id_pattern.search(dch) else dch for dch in environ.get('DELETE_CHANNELS', '0').split()]
MAX_B_TN = environ.get("MAX_B_TN", "5")
MAX_BTN = is_enabled((environ.get('MAX_BTN', "True")), True)
PORT = environ.get("PORT", "8080")
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/MoneyCaseSupport')
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/MoneyCaseOfficial')
MSG_ALRT = environ.get('MSG_ALRT', 'Wʜᴀᴛ Aʀᴇ Yᴏᴜ Lᴏᴏᴋɪɴɢ Aᴛ ?')
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001743072559'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'MoneyCaseSupport')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001894484267')).split()]
