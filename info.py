...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1001796447430').split()]
...
VERIFY2_API = environ.get('VERIFY2_API', "600ea6946edfb286f42f5797da7ed68e7c855f50")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001704441177')).split()]
